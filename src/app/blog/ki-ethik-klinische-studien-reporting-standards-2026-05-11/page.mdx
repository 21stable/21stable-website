...
Die Konsequenz: Proprietäre Algorithmen operieren im methodischen Blindflug. Prüfstatistiker und Ethikkommissionen können weder die Validität KI-generierter Stratifizierungsentscheidungen beurteilen noch die Fairness automatisierter Rekrutierungsprozesse auditieren. Hier entsteht ein Accountability-Vakuum, das in Widerspruch zu den Grundprinzipien der Guten Klinischen Praxis (GCP) steht.
